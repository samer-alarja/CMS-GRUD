...
<body>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse right" style="justify-content: right;" id="navbarNav">
                        <ul class="navbar-nav ml-auto">
                                <li class="nav-item">
                                    <a class="nav-link" href="en.html">menu</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="ara.html">login</a>
                                </li>
                                <li class="nav-item">
    ...
    <script
        src="file:///C:/Users/webtrainee/Downloads/OwlCarousel2-2.3.4/OwlCarousel2-2.3.4/docs/assets/owlcarousel/owl.carousel.js"></script>
</body>
</html>