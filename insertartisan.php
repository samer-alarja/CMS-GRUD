...
//     $insert_product = mysqli_query($link , 'INSERT INTO artical(title,body,full_image,thumbnail,category,language,publish,user_id,featured,meta_description,meta_keyword) 
//                                 VALUES ( "'.$_POST['title'].'","'. $_POST['body'].'",
//                                          "'.$_POST['full_image'].'","'.$_POST['thumbnail'].'",
//                                          "'.$_POST['category'].'","'.$_POST['language'].'",
//                                          "'.$_POST['publish'].'","'.$_POST['user_id'].'",
//                                          "'.$_POST['featured'].'","'.$_POST['meta_description'].'",
//                                          "'.$_POST['meta_keyword'].'")');
