...
<?php 
$select_menu = mysqli_query($link , ' SELECT * from setting');
                    while($exc = mysqli_fetch_assoc($select_menu)){
                      echo '<Tr>';
                      echo '<Td>'.$exc['website_name'].'</td>';
                      echo '<Td>'.$exc['logo'].'</td>';
                      echo '<Td>'.$exc['CSS'].'</td>';
                      echo '<Td>'.$exc['JS'].'</td>';
                      ...
                      echo '<Td><a href="sittingedit.php?id='.$exc['id'].'" class="btn btn-primary">Edit</a>
                                <a href="sittingdelete.php?id='.$exc['id'].'" class="btn btn-primary">Delete</a></td>';
                      echo '</tr>';
                    }
?>
</table>
