...
<?php } ?>
 <div style="background:white; background-size:cover; background-attachment:fixed; height:800px;padding:100px">
  <form method="post" action="checklogin.php" style=" border-radius: 25px;background-color: #f2f2f2;width:600px;margin:0 0 0 400px;padding:50px"> 
  ...
  <hr style="height:1px;border-width:0;background-color:gray">
    ...
    <br>
    <a href="register.php" style="margin-left: 75px;">create new account</a>
    <br>
  </form>
</div>
</body>
